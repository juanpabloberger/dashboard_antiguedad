...
st.set_page_config(page_title="ANTIGUEDAD PSYCHO BUNNY GT", layout="wide")
...
st.markdown('<h1 class="title">ANTIGUEDAD PSYCHO BUNNY</h1>', unsafe_allow_html=True)
...
st.write("Total Stock Actual for PSYCHO BUNNY:", f"{df['Stock_Actual'].sum():,.0f}")
