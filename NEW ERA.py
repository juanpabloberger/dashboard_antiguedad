...
st.set_page_config(page_title="ANTIGUEDAD ACCESSA GT", layout="wide")
...
st.markdown('<h1 class="title">ANTIGUEDAD NEW ERA</h1>', unsafe_allow_html=True)
...
# tHOUSAND SEPARATOR = ','
st.write("Total Stock Actual for NEW ERA:", f"{df['Stock_Actual'].sum():,.0f}")
